...
<body data-spy="scroll" data-target=".navbar" data-offset="51">
            ...
            <div class="row align-items-center">
                <div class="col-sm-12 col-md-6">
                    <div class="hero-content">
                        <div class="hero-text">
                            <p>I'm</p>
                            <h1>Aflakah Nur Farhana</h1>
                            <h2></h2>
                            <div class="typed-text">UX Researcher, UI Designer, Front End Developer, Apps Designer, Apps Developer</div>
                        </div>
                        <div class="hero-btn">
    ...
    <script src="<?= base_url('https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/js/bootstrap.bundle.min.js') ?>"></script>-->
